    ...
    <main>
        ...
        <div className='mb-20'>
            <ul className='list-none text text-black dark:text-white p-5'>
                <li className="mb-2  before:content-['\2022'] before:text-pink before:text-2xl before:mx-2">Atualmente tenho disponibilidade para trabalhar tanto como PJ quanto CLT.</li>
                ...
                <li className="mb-2 before:content-['\2022'] before:text-pink before:text-2xl before:mx-2">Meu desejo é trabalhar em um empresa onde eu seja desafiada a sair da zona de conforto, contribuir para o crescimento da empresa e crescer profissionalmente junto!</li>
            ...
            <ButtonLink link='linkedin.com' > Enviar Proposta no Email</ButtonLink>
            <ButtonLink link='linkedin.com' > Conversar no Whatsapp</ButtonLink>
            </div>
      </div>
    </main>
  )
