...
export default function Estudos() {
  ...
  return (
    <main className='w-full lg:max-w-[900px] xl:max-w-[1100px] ' >
      ...
      <div className='h-relative flex justify-evenly items-center mb-0  md:pb-[50px] '>
        <Slider settings={settings} >
          {CardEstudos.map((cardItem, index) => (

            <SwiperSlide key={index} >
              <div className='w-[80%] max-w-[300px] h-[60%] min-h-[320px] md:max-w-[400px] mt-2 mb-2  flex flex-col justify-evenly text-center p-4 bg-background-ligth dark:bg-background-dark border border-gray rounded-xl hover:border-pink'>
